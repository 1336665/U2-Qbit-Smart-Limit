    ...
    def load(path: str, db: 'Database' = None) -> Tuple[Optional['Config'], Optional[str]]:
        try:
            ...
            cfg = Config(
                ...
                cleanup_min_seeding_time=int(clean.get('min_seeding_time_hours', d.get('cleanup_min_seeding_time', 24)) or 24) * 3600 if clean.get('min_seeding_time_hours') else int(d.get('cleanup_min_seeding_time', 86400) or 86400),
